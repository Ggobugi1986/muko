...
const Card = ({ color, title, description, image }) => {
        ...
        <div className="absolute inset-x-3 bottom-4 h-40 flex flex-col py-4 border border-blue-300 rounded-lg bg-blue-50">
          ...
          <div className="px-4">
            <div className="h-8 flex items-center justify-center rounded-md bg-blue-300">
              <div className="text-sm font-semibold text-blue-900">더보기</div>
            </div>
          </div>
        </div>
      </div>
  ...
  if (color === 'green') {
    return (
      <div className="relative w-1/2 h-72 px-1 pt-8">
        <div className="h-48 border border-green-300 rounded-lg bg-green-200" />

        <div className="absolute inset-x-0 top-0 flex justify-center">
          {renderImage()}
        </div>

        <div className="absolute inset-x-3 bottom-4 h-40 flex flex-col py-4 border border-green-300 rounded-lg bg-green-50">
          <div className="flex-1 flex flex-col items-center">
            <div className="mb-2 truncate">
              <div className="font-bold text-green-700">{title}</div>
            </div>
          ...
          <div className="px-4">
            <div className="h-8 flex items-center justify-center rounded-md bg-green-300">
              <div className="text-sm font-semibold text-green-900">더보기</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="absolute inset-x-3 bottom-4 h-40 flex flex-col py-4 border border-teal-300 rounded-lg bg-teal-50">
          ...
          <div className="px-4">
            <div className="h-8 flex items-center justify-center rounded-md bg-teal-300">
              <div className="text-sm font-semibold text-teal-900">더보기</div>
            </div>
          </div>
        </div>
      </div>
